...
const reportStyles = `
.employee-report-portal.standalone{background:#f6f7f9!important;padding:34px 18px!important}.report-topbar{padding:14px 16px;border:1px solid #e1e5eb;border-radius:14px;background:#fff}.employee-report-portal .anonymity-shield-banner{border:1px solid #dbe5fb;border-radius:13px;background:#f5f8ff;background-image:none}.employee-report-portal .anonymity-shield-banner svg{color:#4f46e5!important}.employee-report-portal .anonymity-shield-banner>div>div:first-child{color:#101828!important;font-size:12px!important}.employee-report-portal .anonymity-shield-banner>div>div:last-child{margin-top:3px;font-size:11px!important;line-height:1.5}.employee-report-portal.embedded>div:first-child{margin-bottom:12px!important}.employee-report-card{max-width:800px!important;padding:27px!important;border-color:#e1e5eb!important;border-radius:17px!important;box-shadow:0 5px 18px rgba(16,24,40,.035)!important}.employee-report-card>div:first-child{gap:8px}.employee-report-card .btn{min-height:42px;border-radius:9px;font-size:12px;font-weight:750}.employee-report-card .btn-teal,.employee-report-card .btn-coral{border-color:#17191d;background:#17191d;color:#fff}.employee-report-card .btn-teal:hover,.employee-report-card .btn-coral:hover{border-color:#4f46e5;background:#4f46e5}.employee-report-card .form-textarea,.employee-report-card .form-input{border-color:#d8dde5;border-radius:10px;background:#fff}.employee-report-card .form-textarea:focus,.employee-report-card .form-input:focus{border-color:#818cf8;box-shadow:0 0 0 4px rgba(37,99,235,.08)}.employee-report-card h2,.employee-report-card h3{color:#101828!important}.employee-report-card>form+div>div:nth-child(2)>div:first-child{background:#17191d!important}.employee-report-card .badge-teal{background:#eef2ff;color:#4338ca}.report-step>div:first-child{background:#e4e7ec!important;color:#667085!important}.report-step.active>div:first-child{background:#17191d!important;color:#fff!important}.report-step.done>div:first-child{background:#4f46e5!important;color:#fff!important}.report-category{border:1px solid #e1e5eb!important;border-radius:11px!important;background:#fff!important;transition:.2s}.report-category:hover{border-color:#aeb7c5!important;background:#fafbfc!important}.report-category.selected{border:1.5px solid #818cf8!important;background:#f5f8ff!important}.report-category>div:first-child{border-color:#4f46e5!important}.report-category.selected>div:first-child{background:#4f46e5!important}.report-category>div:last-child>div:first-child{color:#101828!important}@media(max-width:620px){.employee-report-portal.standalone{padding:14px!important}.report-topbar{align-items:flex-start!important;gap:12px;flex-direction:column}.employee-report-card{padding:19px!important}.employee-report-card>div:first-child{overflow-x:auto}.employee-report-card>div:first-child>div{min-width:120px}.report-top-actions{width:100%}.report-top-actions button{flex:1}}@media(prefers-reduced-motion:reduce){.employee-report-portal *{animation:none!important;transition:none!important}}
`;
