    ...
    <main className="login-page">
      <section className="login-area">
        <div className="login-card">
          <Link className="login-brand" to="/"><img src="/logo.png" alt="FairLens" /><span>FairLens</span></Link>
...
const styles = `
.login-page{position:relative;min-height:100vh;display:grid;place-items:center;overflow:hidden;padding:40px 18px;background:linear-gradient(145deg,#f4f6f9 0%,#fff 48%,#eef3fb 100%);color:#111827}.login-page:before,.login-page:after{content:"";position:absolute;border-radius:50%;pointer-events:none}.login-page:before{width:340px;height:340px;left:-170px;bottom:-170px;background:rgba(37,99,235,.055)}.login-page:after{width:230px;height:230px;right:-100px;top:-105px;border:42px solid rgba(17,24,39,.025)}.login-area{position:relative;z-index:1;width:100%;display:grid;place-items:center}.login-card{position:relative;overflow:hidden;width:100%;max-width:480px;padding:40px;border:1px solid rgba(213,219,228,.9);border-radius:22px;background:rgba(255,255,255,.96);box-shadow:0 24px 65px rgba(17,24,39,.1);animation:card-in .65s cubic-bezier(.2,.8,.2,1) both}.login-card:before{content:"";position:absolute;top:0;left:0;right:0;height:4px;background:#4f46e5}.login-brand{display:flex;align-items:center;gap:10px;width:max-content;margin-bottom:35px;color:#111827;text-decoration:none;font-family:var(--font-serif);font-size:21px;font-weight:700}.login-brand img{width:40px;height:40px;border-radius:11px;object-fit:contain;background:#17191d;padding:6px;box-shadow:0 7px 16px rgba(17,24,39,.17)}.login-heading>span{color:#4f46e5;font-size:12px;font-weight:800;text-transform:uppercase;letter-spacing:.07em}.login-heading h2{margin:6px 0;color:#111827;font-family:var(--font-serif);font-size:39px;letter-spacing:-.035em}.login-heading p{color:#6b7280;font-size:14px}.role-switch{display:grid;grid-template-columns:1fr 1fr;gap:6px;margin:28px 0 24px;padding:5px;border:1px solid #e4e7ec;border-radius:13px;background:#f2f4f7}.role-switch button{display:flex;align-items:center;justify-content:center;gap:8px;padding:12px;border:0;border-radius:9px;background:transparent;color:#667085;font-size:13px;font-weight:700;cursor:pointer;transition:color .2s,background .2s,box-shadow .2s,transform .2s}.role-switch button:hover{color:#111827}.role-switch button.active{background:#fff;color:#4338ca;box-shadow:0 3px 12px rgba(17,24,39,.1)}.role-switch button.active svg{stroke-width:2.4}.login-error{display:flex;align-items:flex-start;gap:8px;margin-bottom:17px;padding:12px 13px;border:1px solid #fecaca;border-radius:10px;background:#fff5f5;color:#b42318;font-size:13px}.login-card form{display:flex;flex-direction:column;gap:18px}.login-card form>label>span{display:block;margin-bottom:8px;color:#344054;font-size:13px;font-weight:700}.login-card form>label>div{display:flex;align-items:center;gap:10px;padding:0 14px;border:1px solid #d8dde5;border-radius:11px;background:#fff;color:#98a2b3;transition:border-color .2s,box-shadow .2s,color .2s}.login-card form>label>div:hover{border-color:#b9c0cc}.login-card form>label>div:focus-within{border-color:#818cf8;box-shadow:0 0 0 4px rgba(37,99,235,.09);color:#4f46e5}.login-card input{width:100%;padding:14px 0;border:0;outline:0;background:transparent;color:#111827;font-size:15px}.login-card form label button{display:grid;place-items:center;padding:5px;border:0;background:transparent;color:#667085;cursor:pointer}.login-submit{display:flex;align-items:center;justify-content:space-between;margin-top:4px;padding:15px 17px;border:0;border-radius:11px;background:#17191d;color:#fff;font-size:14px;font-weight:800;cursor:pointer;box-shadow:0 10px 22px rgba(17,24,39,.17);transition:transform .25s,box-shadow .25s,background .25s}.login-submit:hover:not(:disabled){transform:translateY(-2px);background:#4f46e5;box-shadow:0 15px 28px rgba(37,99,235,.22)}.login-submit:hover svg{transform:translateX(3px)}.login-submit svg{transition:transform .2s}.login-submit:disabled{opacity:.65;cursor:wait}.demo-credential{margin-top:24px;padding:15px;border:1px solid #e1e6ee;border-radius:12px;background:#f8fafc}.demo-credential>div{display:flex;justify-content:space-between;margin-bottom:10px}.demo-credential>div span{color:#4f46e5;font-size:10px;font-weight:800;text-transform:uppercase;letter-spacing:.05em}.demo-credential>div b{color:#667085;font-size:11px}.demo-credential p{display:grid;grid-template-columns:72px 1fr;padding:3px 0;font-size:12px}.demo-credential strong{color:#667085}.demo-credential code{overflow:hidden;color:#263244;font-family:inherit;font-weight:700;text-overflow:ellipsis}.candidate-link{margin-top:22px;color:#667085;text-align:center;font-size:13px}.candidate-link a{color:#4338ca;font-weight:750;text-decoration:none}.candidate-link a:hover{text-decoration:underline}@keyframes card-in{from{opacity:0;transform:translateY(18px) scale(.985)}to{opacity:1;transform:none}}@media(max-width:520px){.login-page{padding:18px}.login-card{padding:26px 23px;border-radius:18px}.login-brand{margin-bottom:29px}.role-switch button{font-size:12px}.login-heading h2{font-size:34px}}@media(prefers-reduced-motion:reduce){.login-page *{animation:none!important;transition:none!important}}
.login-card:before{background:#6b7280}.login-heading>span,.demo-credential>div span{color:#59616b}.role-switch button.active{color:#374151}.login-card form>label>div:focus-within{border-color:#9ca3af;box-shadow:0 0 0 4px rgba(107,114,128,.12);color:#4b5563}.login-submit:hover:not(:disabled){background:#4b5563;box-shadow:0 15px 28px rgba(17,24,39,.2)}.candidate-link a{color:#4b5563}
.login-page{background:linear-gradient(145deg,#eceff1 0%,#f8f9fa 48%,#e5e7eb 100%);filter:grayscale(1)}.login-page:before{background:rgba(107,114,128,.08)}.login-card{border-color:#d1d5db}.role-switch{border-color:#d1d5db;background:#e5e7eb}.role-switch button.active{background:#f9fafb}.demo-credential{border-color:#d1d5db;background:#f3f4f6}
`;
